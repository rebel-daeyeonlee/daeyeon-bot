...
OUTPUT_DIRECTIVE = (
    ...
    "- `APPROVE` — zero findings (CRITICAL=0, MAJOR=0, MINOR=0). Posts as a"
    " GitHub COMMENT review (the bot never submits a formal GitHub APPROVE"
    " event) carrying a celebratory 곽철이 GIF. Reserve this for PRs that"
    " genuinely deserve approval — no fence-sitting. The schema rejects"
    " APPROVE when `comments[]` is non-empty.\n"
